...
project {
    ...
    params {
        ...
        text("env.PUBLISHED_JAVA_GROUP", "", label = "net.minecraftforge.trainingwheels", description = "The maven coordinate group that has been published by this build. Can not be empty.", allowEmpty = false)
