...
project {
    ...
    params {
        ...
        text("env.PUBLISHED_JAVA_GROUP", "net.minecraftforge.trainingwheels", label = "Published group id", description = "The maven coordinate group that has been published by this build. Can not be empty.", allowEmpty = false)
